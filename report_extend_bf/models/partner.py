...
class ResPartner(models.Model):
    ...
    display_address_without_company = fields.Text(string='Display addres without company', compute="_compute_display_address")
    display_address_without_company_line = fields.Text(string='Display addres without company line', compute="_compute_display_address")
